<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
  :mainPage="$t('operatingSystem.configuration')"
  :mainSubPage="$t('operatingSystem.assets')"
  :subPage="$t('operatingSystem.operatingSystem')"
  :titlePage="$t('operatingSystem.title')"  
  v-permission:show
  >
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      {
        title: this.$t("operatingSystem.name"),
        data: "name",
        defaultContent: "N/A",
      },
      {
        id: "created_at",
        title: this.$t("operatingSystem.date"),
        data: "created_at",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("operatingSystem.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("operatingSystem.please_enter_your_name"),
