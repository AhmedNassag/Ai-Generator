  ...
  <div class="login-container">
    <div class="login-left">
      <div class="left-content">
        <div class="logo-section">
          <img class="company-logo" src="@/assets/Cybermode.png" alt="Advanced Controls" />
        </div>
      </div>
    </div>
    <div class="login-right">
      <div class="login-card">
        ...
        <form class="theme-form" @submit.prevent="handleLogin">
          <div class="form-group">
            ...
            <input class="form-control" type="text" v-model="login" required placeholder="Email Or Username" />
          </div>
          <div class="form-group">
      ...
      <div class="footer-text">
        COPYRIGHT © 2025 <span class="footer-link">Cyber Mode</span>, All Rights Reserved
      </div>
    </div>
  </div>
</template>
...
.form-control:focus {
  border-color: #6E3894;
  outline: none;
  box-shadow: 0 0 0 1px rgba(110, 56, 148, 0.1);
}
