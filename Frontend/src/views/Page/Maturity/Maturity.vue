<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="$t('maturity.module')" :subPage="$t('maturity.module')"
    :titlePage="$t('maturity.module')" v-permission:show>
...
import maturity from "@/API/Maturity/Maturity";
    ...
    this.fromFields = [
      {
        ...
        description: this.$t("maturity.name_description"), // Description for the field
