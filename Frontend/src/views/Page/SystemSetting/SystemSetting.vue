<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'systemsetting.systemsetting'" :subPage="'systemsetting.systemsetting'" :titlePage="'systemsetting.systemsetting'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("systemsetting.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("systemsetting.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("systemsettingname"),
      ...
      {
        name: "email",
        label: this.$t("systemsettingemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("systemsetting.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("systemsetting.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("systemsetting.description"),
