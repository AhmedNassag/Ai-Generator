<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'physicalcoursegrade.physicalcoursegrade'" :subPage="'physicalcoursegrade.physicalcoursegrade'" :titlePage="'physicalcoursegrade.physicalcoursegrade'">
...
import physicalcoursegrade from "@/API/PhysicalCourseGrade/PhysicalCourseGrade";
...
export default {
  ...
  setup() {
    ...
    const api = new physicalcoursegrade();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("physicalcoursegrade.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("physicalcoursegrade.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("physicalcoursegradename"),
      ...
      {
        name: "email",
        label: this.$t("physicalcoursegradeemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("physicalcoursegrade.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("physicalcoursegrade.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("physicalcoursegrade.description"),
