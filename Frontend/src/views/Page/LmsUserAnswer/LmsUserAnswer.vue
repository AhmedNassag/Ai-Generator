<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'lmsuseranswer.lmsuseranswer'" :subPage="'lmsuseranswer.lmsuseranswer'" :titlePage="'lmsuseranswer.lmsuseranswer'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("lmsuseranswer.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("lmsuseranswer.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("lmsuseranswername"),
      ...
      {
        name: "email",
        label: this.$t("lmsuseransweremail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("lmsuseranswer.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("lmsuseranswer.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("lmsuseranswer.description"),
