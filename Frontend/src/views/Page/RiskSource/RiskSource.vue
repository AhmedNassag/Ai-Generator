<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'risksource.risksource'" :subPage="'risksource.risksource'" :titlePage="'risksource.risksource'">
    ...
    <template #datatable>
      ...
      >
        ...
        <template #risksource.created_at="{ item }"> {{ formatDate(item.created_at) }} </template>
      </DataTable>
    </template>
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("risksource.name"), data: "name", defaultContent: "N/A" },
      { title: this.$t("risksource.created_at"), data: "created_at", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("risksource.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: "Please enter Risk Source Name.",
