<template>
  ...
  <main-page ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('riskfunction.Risk Function')"
    :mainSubPage="$t('riskfunction.Risk Function')"
    :titlePage="$t('riskfunction.Risk Function')"
    v-permission:show
  >
...
import riskfunction from "@/API/RiskFunction/RiskFunction";
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { id: "name", title: this.$t("riskfunction.name"), data: "name", defaultContent: "N/A" },
      { id: "created_at", title: this.$t("riskfunction.created at"), data: "created_at", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("riskfunction.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("riskfunction.Please enter name"),
