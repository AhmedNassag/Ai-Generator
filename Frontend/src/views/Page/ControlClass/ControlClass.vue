<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'controlclass.controlclass'" :subPage="'controlclass.controlclass'" :titlePage="'controlclass.controlclass'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("controlclass.name"), data: "name", defaultContent: "N/A" },
    ];
