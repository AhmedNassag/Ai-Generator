<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'review.review'" :subPage="'review.review'" :titlePage="'review.review'">
    ...
    <template #datatable>
      ...
      >
        ...
        <template #review.created_at="{ item }"> {{ formatDate(item.created_at) }} </template>
      </DataTable>
    </template>
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      ...
      { title: this.$t("review.name"), data: "name", defaultContent: "N/A" },
      { title: this.$t("review.created_at"), data: "created_at", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("review.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: "Please enter Review Name.",
