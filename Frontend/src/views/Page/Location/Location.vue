<template>
  ...
  <main-page ref="page" v-permission:show :isFlipped="isFlipped"
   :mainPage="$t('governance.governance')"
   :mainSubPage="$t('common.configration')" 
   :subPage="$t('common.location')"
   :titlePage="$t('common.location')">
