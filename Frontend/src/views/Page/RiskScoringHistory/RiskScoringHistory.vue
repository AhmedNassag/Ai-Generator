<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'riskscoringhistory.riskscoringhistory'" :subPage="'riskscoringhistory.riskscoringhistory'" :titlePage="'riskscoringhistory.riskscoringhistory'">
...
export default {
  ...
  setup() {
    ...
    const api = new riskscoringhistory();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("riskscoringhistory.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("riskscoringhistory.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("riskscoringhistoryname"),
      ...
      {
        name: "email",
        label: this.$t("riskscoringhistoryemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("riskscoringhistory.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("riskscoringhistory.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("riskscoringhistory.description"),
