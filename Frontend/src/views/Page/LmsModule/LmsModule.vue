<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'lmsmodule.lmsmodule'" :subPage="'lmsmodule.lmsmodule'" :titlePage="'lmsmodule.lmsmodule'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("lmsmodule.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("lmsmodule.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("lmsmodule.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("lmsmodule.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("lmsmodule.description"),
