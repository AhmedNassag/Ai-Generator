<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('thirdpartyservice.configuration')"
    :mainSubPage="$t('thirdpartyservice.thirdParty')"
    :subPage="$t('thirdpartyservice.service')"
    :titlePage="$t('thirdpartyservice.thirdpartyservice')"
    v-permission:show
  >
...
export default {
  ...
  setup() {
    ...
    const api = new thirdpartyservice();
  ...
  created() {
    ...
    this.tableColumns = [
      {
        ...
        title: this.$t("thirdpartyservice.name"),
        data: "name",
        defaultContent: "N/A",
      },
      {
        id: "created_at",
        title: this.$t("thirdpartyservice.date"),
        data: "created_at",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("thirdpartyservice.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("thirdpartyservice.please_enter_third_party_name"),
