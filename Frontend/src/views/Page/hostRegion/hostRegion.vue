<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
      :mainPage="$t('hostRegion.configuration')"
      :mainSubPage="$t('hostRegion.assets')"
      :subPage="$t('hostRegion.hostRegion')"
      :titlePage="$t('hostRegion.title')"
    v-permission:show
  >
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      {
        title: this.$t("hostRegion.name"),
        data: "name",
        defaultContent: "N/A",
      },
      {
        id: "created_at",
        title: this.$t("hostRegion.date"),
        data: "created_at",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("HostRegion Name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("hostRegion.please_enter_your_full_name")  ,
