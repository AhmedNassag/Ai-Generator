<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'physicalcourserequest.physicalcourserequest'" :subPage="'physicalcourserequest.physicalcourserequest'" :titlePage="'physicalcourserequest.physicalcourserequest'">
...
export default {
  ...
  setup() {
    ...
    const api = new physicalcourserequest();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("physicalcourserequest.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("physicalcourserequest.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("physicalcourserequestname"),
      ...
      {
        name: "email",
        label: this.$t("physicalcourserequestemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("physicalcourserequest.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("physicalcourserequest.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("physicalcourserequest.description"),
