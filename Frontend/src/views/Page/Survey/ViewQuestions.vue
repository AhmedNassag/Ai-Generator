      ...
      >
        ...
        <template #view="{ item }">
          <a
            ...
            class="dropdown-item"
          >
            <i class="fa-solid fa-eye"></i> {{ $t("viewQuestions.overview") }}
          </a>
        </template>
        <template #edit="{ item }">
          <a
            ...
            class="dropdown-item"
          >
            <i class="icofont icofont-fountain-pen"></i> {{ $t("viewQuestions.edit") }}
          </a>
        </template>
        ...
        <template #delete="{ item }">
          <a
            ...
            ><i class="icofont icofont-trash text-danger"></i> {{ $t("viewQuestions.delete") }}</a
          >
        </template>
      </DataTable>
    </template>
        ...
        <template #type="{ item }">
          <div class="mb-3">
            ...
            <select
              ...
              id="question-type"
            >
              <option value="single">{{ $t("viewQuestions.singleselect") }}</option>
              <option value="multi">{{ $t("viewQuestions.multiselect") }}</option>
            </select>
          </div>
        </template>
        ...
        <template #answers[]="{ item }">
          <div class="mb-3">
            ...
            <button
              ...
              type="button"
            >
              <i class="fa-solid fa-plus"></i> {{ $t("viewQuestions.addoption") }}
            </button>
          </div>
        </template>
      </Form>
      ...
      <div class="modal-body">
        <div class="row mb-3">
          ...
          <div class="col-md-12 mt-3">
            <label style="font-weight: 900" class="form-label">{{ $t("viewQuestions.options") }}:</label>
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("viewQuestions.question"), data: "question", defaultContent: "N/A" },
      { id: "type", title: this.$t("viewQuestions.type"), data: "type", defaultContent: "N/A" },
    ];
