<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('objectiveType.objectiveType')"
    :subPage="$t('objectiveType.objectiveType')"
    :titlePage="$t('objectiveType.objectiveType')"
    v-permission:show
  >
    ...
    <template #datatable>
      ...
      >
        ...
        <template #objectiveType.description="{ item }">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { 
        id: "objectiveType.name",
        title: this.$t("objectiveType.name"),
        data: "name",
        defaultContent: "N/A"
      },
      {
        id: "objectiveType.description",
        title: this.$t("objectiveType.description"),
        data: "description",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("objectiveType.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("objectiveType.Please enter name"),
        col: 6, // Column size in the form layout
      },
      {
        name: "description",
        label: this.$t("objectiveType.description"),
        type: "textarea", // Multi-line text field
        rules: "optional", // Validation rule: required field
        description: this.$t("objectiveType.Provide a description"),
        col: 12,
      },
    ];
  },
