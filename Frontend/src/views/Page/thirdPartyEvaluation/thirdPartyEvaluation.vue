<template>
  ...
  <main-page
     ref="page"
  :isFlipped="isFlipped"
  :mainPage="$t('thirdPartyEvaluation.configuration')"
  :mainSubPage="$t('thirdPartyEvaluation.thirdParty')"
  :subPage="$t('thirdPartyEvaluation.evaluation')"
  :titlePage="$t('thirdPartyEvaluation.thirdPartyEvaluation')"
  v-permission:show
>
...
export default {
  ...
  setup() {
    ...
    const api = new thirdpartyevaluation();
  ...
  created() {
    ...
    this.tableColumns = [
      {
        title: this.$t("thirdPartyEvaluation.name"),
        data: "name",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("thirdPartyEvaluation.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("thirdPartyEvaluation.please_enter_third_party_name"),
