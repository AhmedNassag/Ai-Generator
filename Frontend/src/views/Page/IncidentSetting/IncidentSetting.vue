<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'incidentsetting.incidentsetting'" :subPage="'incidentsetting.incidentsetting'" :titlePage="'incidentsetting.incidentsetting'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("incidentsetting.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("incidentsetting.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("incidentsettingname"),
      ...
      {
        name: "email",
        label: this.$t("incidentsettingemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("incidentsetting.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("incidentsetting.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("incidentsetting.description"),
