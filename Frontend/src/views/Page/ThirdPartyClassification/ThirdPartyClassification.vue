<template>
  ...
  <main-page ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('thirdPartyClassification.Configuration')"
    :mainSubPage="$t('thirdPartyClassification.Third Party Classification')"
    :titlePage="$t('thirdPartyClassification.Third Party Classification')"
    v-permission:show
  >
...
export default {
  ...
  setup() {
    ...
    const api = new thirdPartyClassification();
    const apiParams = {};
  ...
  created() {
    ...
    this.tableColumns = [
      { id: "name", title: this.$t("thirdPartyClassification.name"), data: "name", defaultContent: "N/A" },
      { id: "created_at", title: this.$t("thirdPartyClassification.created at"), data: "created_at", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("thirdPartyClassification.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("thirdPartyClassification.Please enter name"),
