        ...
        >
          ...
          <div class="action-main-content">
            ...
            <div class="action-metadata">
              ...
              <span class="metadata-item notification-type-badge">
                <svg v-if="item.type === 'system'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 1C4.13 1 1 4.13 1 8C1 11.87 4.13 15 8 15C11.87 15 15 11.87 15 8C15 4.13 11.87 1 8 1ZM8 13C5.24 13 3 10.76 3 8C3 5.24 5.24 3 8 3C10.76 3 13 5.24 13 8C13 10.76 10.76 13 8 13Z" fill="#7c3aed"/>
                </svg>
                <svg v-else width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 3C2 2.44772 2.44772 2 3 2H13C13.5523 2 14 2.44772 14 3V11C14 11.5523 13.5523 12 13 12H3C2.44772 12 2 11.5523 2 11V3Z" stroke="#10b981" stroke-width="1.5"/>
                  <path d="M2 3L8 8L14 3" stroke="#10b981" stroke-width="1.5"/>
                </svg>
                {{ item.type === 'system' ? $t("notificationsetting.system") : $t("notificationsetting.email") }}
              </span>
            </div>
          </div>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="modal-section">
            <h4 class="section-title">
              {{ $t("notificationsetting.notification_type") || "Notification Type" }}
            </h4>
            <div class="form-group">
              <label class="sub-section-label">
                {{ $t("notificationsetting.select_notification_type") || "Select Notification Type" }}
              </label>
              <v-select
                ...
                label="label"
                class="style-chooser notification-type-select"
                :placeholder="$t('notificationsetting.choose_type') || 'Choose notification type'"
              >
                <template #option="option">
                  <div class="type-option">
                    <svg v-if="option.value === 'system'" width="20" height="20" viewBox="0 0 16 16" fill="none">
                      <path d="M8 1C4.13 1 1 4.13 1 8C1 11.87 4.13 15 8 15C11.87 15 15 11.87 15 8C15 4.13 11.87 1 8 1ZM8 13C5.24 13 3 10.76 3 8C3 5.24 5.24 3 8 3C10.76 3 13 5.24 13 8C13 10.76 10.76 13 8 13Z" fill="#7c3aed"/>
                    </svg>
          ...
          <div class="modal-section section-1">
            ...
            >
              ...
              <input
                ...
                :placeholder="$t('notificationsetting.email_subject') || 'Email Subject'"
              />
            </div>
          ...
          <div class="modal-section">
            ...
            <div class="form-group sub-section-container">
              ...
              <v-select
                ...
                label="name"
                class="style-chooser"
                :placeholder="$t('notificationsetting.select_related_users') || 'Select related users'"
              />
            </div>
            ...
            <div class="form-group sub-section-container">
              ...
              <UserSelect
                ...
                label="full_name"
                class="style-chooser"
                :placeholder="$t('notificationsetting.select_users') || 'Select users'"
              />
            </div>
            ...
            <div class="sub-section-container">
              <div class="form-group">
                ...
                <div class="department-job-row">
                  <div class="department-col">
                    ...
                    <v-select
                      ...
                      :placeholder="$t('notificationsetting.select_department') || 'Select a department'"
                    />
                  </div>
                  ...
                  <div class="job-col">
                    ...
                    <v-select
                      ...
                      :getOptionLabel="(option) => option.name"
                      class="form-control p-0 small"
                      :placeholder="$t('notificationsetting.select_job') || 'Select a job'"
                    />
                  </div>
                ...
                >
                  ...
                  <span
                    >{{ $t("notificationsetting.no_roles_warning") || "This job has no assigned roles. Please select a job that includes roles." }}</span
                  >
                </div>
              </div>
  ...
  data() {
    return {
      ...
      notificationTypeOptions: [
        {
          value: "system",
          label: this.$t("notificationsetting.system_notifications") || "System Notifications",
        },
        {
          value: "email",
          label: this.$t("notificationsetting.email_notifications") || "Email Notifications",
        },
      ],
    };
  },
  ...
  computed: {
    filteredNotifications() {
      return this.notifications.filter(
        (item) => !this.excludedActions.includes(item.action)
      );
    },
  },
  ...
  methods: {
    ...
    openModal(item) {
      ...
      this.formData = {
        ...
        type: item.type || "system", // Load the notification type
      };
    ...
    async handleSubmit() {
      try {
        ...
        const formDataToSubmit = {
          ...
          type: this.formData.type, // Include the notification type
        };
    ...
    addFillable(fieldName) {
      ...
      if (editor) {
        ...
        editor.model.change((writer) => {
          writer.setSelection(positionAtEnd);
...
.notification-type-select .vs__dropdown-toggle {
  padding: 0.5rem;
  border-radius: 8px;
}
