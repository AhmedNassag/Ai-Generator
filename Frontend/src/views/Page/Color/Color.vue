<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('color.configurations')"
    :mainSubPage="$t('color.department')"
    :subPage="$t('color.color')"
    :titlePage="$t('color.title')"
    v-permission:show
  >
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { id: "hexcolor",
        title: this.$t("color.hexcode"),
        data: "hexcolor",
        defaultContent: "N/A",
      },
      { title: this.$t("color.name"), data: "name", defaultContent: "N/A" },
    ];
