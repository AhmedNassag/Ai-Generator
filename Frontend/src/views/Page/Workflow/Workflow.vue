<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'workflow.workflow'" :subPage="'workflow.workflow'" :titlePage="'workflow.workflow'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("workflow.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("workflow.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("workflow.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("workflow.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("workflow.description"),
