<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'widget.widget'" :subPage="'widget.widget'" :titlePage="'widget.widget'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("widget.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("widget.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("widget.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("widget.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("widget.description"),
