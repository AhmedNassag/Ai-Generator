<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'physicalcourseattendance.physicalcourseattendance'" :subPage="'physicalcourseattendance.physicalcourseattendance'" :titlePage="'physicalcourseattendance.physicalcourseattendance'">
...
import physicalcourseattendance from "@/API/PhysicalCourseAttendance/PhysicalCourseAttendance";
...
export default {
  ...
  setup() {
    ...
    const api = new physicalcourseattendance();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("physicalcourseattendance.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("physicalcourseattendance.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("physicalcourseattendancename"),
      ...
      {
        name: "email",
        label: this.$t("physicalcourseattendanceemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("physicalcourseattendance.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("physicalcourseattendance.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("physicalcourseattendance.description"),
