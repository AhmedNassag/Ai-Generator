...
<main-page
  ref="page"
  :isFlipped="isFlipped"
  :mainPage="$t('threatGroup.configuration')"
  :mainSubPage="$t('threatGroup.risk')"
  :subPage="$t('threatGroup.threatGroup')"
  :titlePage="$t('threatGroup.title')"
  v-permission:show
>
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("threatGroup.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("threatGroup.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("threatGroup.please_enter_threat_group_name"),
