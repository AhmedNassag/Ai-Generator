<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'physicalcourseschedule.physicalcourseschedule'" :subPage="'physicalcourseschedule.physicalcourseschedule'" :titlePage="'physicalcourseschedule.physicalcourseschedule'">
...
import physicalcourseschedule from "@/API/PhysicalCourseSchedule/PhysicalCourseSchedule";
...
export default {
  ...
  setup() {
    ...
    const api = new physicalcourseschedule();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("physicalcourseschedule.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("physicalcourseschedule.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("physicalcourseschedulename"),
      ...
      {
        name: "email",
        label: this.$t("physicalcoursescheduleemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("physicalcourseschedule.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("physicalcourseschedule.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("physicalcourseschedule.description"),
