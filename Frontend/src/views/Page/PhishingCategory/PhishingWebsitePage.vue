            ...
            <div class="card">
              <div class="product-box">
                <div class="product-img">
                  <img class="img-fluid" :src="website.fullCoverPath" alt="" />
          ...
          <v-row>
            ...
            <v-col cols="12" md="6">
              ...
              <v-select id="Category" v-model="formData.phishing_category_id" :options="categories"
                :placeholder="$t('phishingwebsitepage.SelectCategory')" :reduce="option => option.id" label="name"
                clearable :rules="[v => !!v || $t('phishingwebsitepage.CategoryIsRequired')]"></v-select>
            ...
            <v-col cols="12" md="12">
              ...
              <v-radio-group v-model="formData.type" :rules="[v => !!v || $t('phishingwebsitepage.TypeIsRequired')]">
                <v-row>
                  <v-col cols="auto">
            ...
            <v-col cols="12" md="6" v-if="formData.type === 'managed'">
              ...
              <v-select id="Domain" v-model="formData.domain_id" :options="domains"
                :placeholder="$t('phishingwebsitepage.SelectDomain')" :reduce="option => option.id" label="name"
                clearable :rules="[v => !!v || $t('phishingwebsitepage.DomainIsRequired')]"></v-select>
            </v-col>
  ...
  methods: {
    async fetchPhishingwebsites(id) {
      ...
      const response = await this.api.getAll({
        filter: `phishing_category_id|${id}|=`,
        page: this.page,
