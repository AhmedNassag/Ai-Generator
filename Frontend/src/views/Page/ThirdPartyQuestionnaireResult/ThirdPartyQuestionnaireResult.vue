<template>
  ...
  :mainPage="'RISK MGMT'" 
  :mainSubPage="'THIRD PARTY'"
  :subPage="'ASSESSMENTS Results'" 
  :titlePage="'ASSESSMENTS Results'"
...
import thirdpartyquestionnaireresult from "@/API/ThirdPartyQuestionnaireResult/ThirdPartyQuestionnaireResult";
...
export default {
  ...
  setup() {
    ...
    const api = new thirdpartyquestionnaireresult();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("thirdpartyquestionnaireresult.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("thirdpartyquestionnaireresult.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("thirdpartyquestionnaireresultname"),
      ...
      {
        name: "email",
        label: this.$t("thirdpartyquestionnaireresultemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("thirdpartyquestionnaireresult.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("thirdpartyquestionnaireresult.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("thirdpartyquestionnaireresult.description"),
