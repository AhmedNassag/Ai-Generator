<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'controlphase.controlphase'" :subPage="'controlphase.controlphase'" :titlePage="'controlphase.controlphase'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("controlphase.name"), data: "name", defaultContent: "N/A" },
    ];
