<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('tag.configuration')"
    :mainSubPage="$t('tag.risk')"
    :subPage="$t('tag.tag')"
    :titlePage="$t('tag.title')"
    v-permission:index
  >
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("tag.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        ...
        description: this.$t("tag.please_enter_your_name"),
