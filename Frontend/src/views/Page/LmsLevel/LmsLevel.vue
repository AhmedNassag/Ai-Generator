<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'lmslevel.lmslevel'" :subPage="'lmslevel.lmslevel'" :titlePage="'lmslevel.lmslevel'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("lmslevel.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("lmslevel.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("lmslevel.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("lmslevel.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("lmslevel.description"),
