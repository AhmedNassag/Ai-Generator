<template>
  ...
  <main-page
    ref="page"
    :isFlipped="isFlipped"
    :mainPage="$t('assetCategory.configuration')"
    :mainSubPage="$t('assetCategory.assets')"
    :subPage="$t('assetCategory.assetCategory')"
    :titlePage="$t('assetCategory.title')"
    v-permission:show
  >
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      {
        title: this.$t("assetCategory.name"),
        data: "name",
        defaultContent: "N/A",
      },
      {
        id: "created_at",
        title: this.$t("assetCategory.date"),
        data: "created_at",
        defaultContent: "N/A",
      },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("assetCategory.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: this.$t("assetCategory.please_enter_your_name"),
