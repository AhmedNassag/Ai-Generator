<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'technology.technology'" :subPage="'technology.technology'" :titlePage="'technology.technology'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title: this.$t("technology.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("technology.name"),
        type: "text", // Text input field
        rules: "required", // Validation rule: required field
        description: "Please enter Technology Name.",
