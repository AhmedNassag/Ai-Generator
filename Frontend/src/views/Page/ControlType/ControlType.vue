<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="$t('control.control')"
    :mainSubPage="$t('common.configration')" :titlePage="$t('control.control_type')" v-permission:show>
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { id: "name", title: this.$t("common.name"), data: "name", defaultContent: "N/A" },
