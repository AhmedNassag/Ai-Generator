<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'report.report'" :subPage="'report.report'" :titlePage="'report.report'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("report.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("report.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("report.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("report.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("report.description"),
