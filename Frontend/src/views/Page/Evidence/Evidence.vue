<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'evidence.evidence'" :subPage="'evidence.evidence'" :titlePage="'evidence.evidence'">
...
export default {
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("evidence.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("evidence.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("evidence.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("evidence.accept_terms_and_conditions"),
