<template>
  ...
  <main-page ref="page" :isFlipped="isFlipped" :mainPage="'physicalcoursematerial.physicalcoursematerial'" :subPage="'physicalcoursematerial.physicalcoursematerial'" :titlePage="'physicalcoursematerial.physicalcoursematerial'">
...
import physicalcoursematerial from "@/API/PhysicalCourseMaterial/PhysicalCourseMaterial";
...
export default {
  ...
  setup() {
    ...
    const api = new physicalcoursematerial();
  ...
  created() {
    ...
    this.tableColumns = [
      { title:  this.$t("physicalcoursematerial.email"), data: "email", defaultContent: "N/A" },
      { title: this.$t("physicalcoursematerial.name"), data: "name", defaultContent: "N/A" },
    ];
    ...
    this.fromFields = [
      {
        name: "name",
        label: this.$t("physicalcoursematerialname"),
      ...
      {
        name: "email",
        label: this.$t("physicalcoursematerialemail"),
      ...
      },
      {
        ...
        name: "myOptions",
        label: this.$t("physicalcoursematerial.my_options"),
        options: [
          { id: 1, name: "Option 1" },
          { id: 2, name: "Option 2" },
        ],
      ...
      {
        name: "terms",
        label: this.$t("physicalcoursematerial.accept_terms_and_conditions"),
      ...
      {
        name: "description",
        label: this.$t("physicalcoursematerial.description"),
