 ...
 <div class="d-flex justify-content-between align-items-center w-100">
   <div class="d-flex justify-content-between align-items-center">
        ...
        <li class="breadcrumb-item mt-1">
          <a href="/" class="">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home vue-feather__content">
      ...
      <div class="d-flex justify-content-between align-items-center">
 <div class="dropdown">
        <button class="btn btn-link text-decoration-none dropdown-toggle p-2" 
                type="button" 
                id="settingsDropdown" 
  ...
  <defs>
    <clipPath id="clip0_415_13902">
      <rect width="20" height="20" fill="white"/>
        ...
        <ul class="dropdown-menu dropdown-menu-end super-dropdown" 
            aria-labelledby="settingsDropdown">
          <li>
            <a class="dropdown-item" href="#" @click.prevent="goToNotificationSetting">
              <v-icon class="me-2">mdi-bell</v-icon>
              <span>Notification Setting</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="#" @click.prevent="goToLogSetting">
      ...
      <button type="button">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  <path d="M11.4417 17.5C11.2952 17.7526 11.0849 17.9622 10.8319 18.1079C10.5788 18.2537 10.292 18.3304 10 18.3304C9.70802 18.3304 9.42116 18.2537 9.16814 18.1079C8.91513 17.9622 8.70484 17.7526 8.55833 17.5M15 6.66666C15 5.34057 14.4732 4.0688 13.5355 3.13112C12.5979 2.19344 11.3261 1.66666 10 1.66666C8.67392 1.66666 7.40215 2.19344 6.46447 3.13112C5.52678 4.0688 5 5.34057 5 6.66666C5 12.5 2.5 14.1667 2.5 14.1667H17.5C17.5 14.1667 15 12.5 15 6.66666Z" stroke="#667085" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
      </button>
      </div>
 </div>
...
export default {
  ...
  computed: {
    containerStyle() {
      const paddingRight = this.drawerWidth === 56 ? '38px' : `${this.drawerWidth}px`;
      return {
  ...
  created() {
    this.dataBreadCrumbl = dataBreadCrumb;
  },
  mounted() {
    new Dropdown(document.getElementById('settingsDropdown'));
    this.dataBreadCrumbl = dataBreadCrumb;
    console.log(this.dataBreadCrumbl, "mainPage");
  },
  watch: {
    dataBreadCrumbl(newVal) {
      this.mainPage = newVal.mainPage;
      this.subPage = newVal.subPage;
      console.log("Data Breadcrumb changed:", newVal);
    },
     '$route.fullPath'(newPath, oldPath) {
      this.mainPage = dataBreadCrumb.mainPage;
      this.subPage = dataBreadCrumb.subPage;
      console.log("Route changed:", dataBreadCrumb);
     }
  },
  methods: {
