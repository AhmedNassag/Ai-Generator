...
class DepartmentFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'number_of_employees' => $this->faker->numberBetween(100, 200),
            'vision' => $this->faker->text(1000),
            'message' => $this->faker->text(1000),
            'mission' => $this->faker->text(1000),
            'objectives' => $this->faker->text(1000),
            'responsibilities' => $this->faker->text(1000),
        ];
    }
}
